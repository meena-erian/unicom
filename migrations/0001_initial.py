# Generated by Django 4.2.20 on 2025-05-29 14:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('misc_tokens', models.JSONField(default=dict, help_text='Secure storage for temporary authentication/access tokens')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('processing_function', models.TextField(help_text="Python function code that should return dict with 'category_match' boolean")),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('PENDING', 'Pending'), ('IDENTIFYING', 'Identifying'), ('CATEGORIZING', 'Categorizing'), ('QUEUED', 'Queued'), ('PROCESSING', 'Processing'), ('COMPLETED', 'Completed'), ('FAILED', 'Failed')], db_index=True, default='PENDING', max_length=20)),
