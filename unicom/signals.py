from unicom.models import Message, AccountChat, BotCredentials
...
@receiver(pre_save, sender=BotCredentials)
def botcredentials_pre_save(sender, instance, **kwargs):
...
@receiver(post_save, sender=BotCredentials)
def run_bot_credentials_after_insert(sender, instance, created, **kwargs):
